  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-agenda-files (list "~/org/1.projects.org"
                                 "~/org/2.areas.org")
...
before packages are loaded."
  ...
  (setq org-capture-templates '(("t" "Task" entry (file+headline "~/org/0.inbox.org" "Tasks")
                                 "* TODO %?\n  %u\n  %a")
                                ("n" "Note" entry (file+headline "~/org/0.inbox.org" "Notes")
                                 "* %?\nEntered on %U\n  %i\n  %a")
